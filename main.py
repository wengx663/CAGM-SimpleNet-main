...
@click.option(
    "--feature_attention",
    type=click.Choice(["none", "eca", "se", "cbam"], case_sensitive=False),
    default="none",
    show_default=True,
)
@click.option("--attention_reduction", type=int, default=16, show_default=True)
@click.option("--attention_kernel_size", type=int, default=3, show_default=True)
@click.option("--feature_l2_norm", is_flag=True)
@click.option("--score_top_k", type=int, default=0, show_default=True)
@click.option("--global_branch", is_flag=True)
@click.option("--global_loss_weight", type=float, default=0.2, show_default=True)
@click.option("--global_score_weight", type=float, default=0.3, show_default=True)
@click.option("--global_noise_std", type=float, default=0, show_default=True)
@click.option("--global_nn_branch", is_flag=True)
@click.option("--global_nn_weight", type=float, default=0.2, show_default=True)
@click.option("--global_nn_k", type=int, default=5, show_default=True)
    ...
    def get_simplenet(input_shape, device):
        ...
        for backbone_name, layers_to_extract_from in zip(
            ...
            simplenet_inst.load(
                ...
                global_nn_branch=global_nn_branch,
                global_nn_weight=global_nn_weight,
                global_nn_k=global_nn_k,
                resume=resume,
            )
